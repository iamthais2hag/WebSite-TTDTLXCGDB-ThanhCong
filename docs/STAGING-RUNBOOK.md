...
6. Chỉ chạy migration khi đã có xác nhận riêng:
...
7. Chạy server local/staging.

8. Chạy client local.

9. Test lookup với dữ liệu mẫu trước, xác nhận API public không trả SoCMT gốc hoặc field nội bộ.

10. Test upload ảnh mẫu bằng JPG nhỏ, không dùng ảnh học viên thật trong repo.

11. Test sync-tool với batch nhỏ 1-5 record trước.

12. Kiểm tra checkpoint:
