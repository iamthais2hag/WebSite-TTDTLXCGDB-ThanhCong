...
export function AnnouncementsPage() {
  return (
    <section className="page-section" id="thong-bao" aria-labelledby="announcements-title">
      <div className="section-heading">
        <p className="section-eyebrow">Thông báo</p>
        <h2 id="announcements-title">Thông báo mới</h2>
        <p>
          Khu vực hiển thị thông báo chính thức của Trung tâm. Nội dung động sẽ
          được bổ sung ở các bước sau nếu được duyệt.
        </p>
      </div>
